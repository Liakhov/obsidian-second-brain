...
> Format described in `.agent/references/index-template.md`.

## Topics

*(empty — will be populated by INGEST as sources are processed)*
...
See [AGENTS.md](../AGENTS.md) for agent rules and
[README.md](../README.md) for human onboarding.
